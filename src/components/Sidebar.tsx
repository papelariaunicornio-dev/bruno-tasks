      ...
      >
        ...
        <div className="space-y-0.5 mb-1">
          ...
          >
            ...
            Em andamento
            <span className="ml-auto text-xs text-gray-400">{allTasks.filter((t) => !!t.in_progress && !t.completed && !t.deleted).length}</span>
          </button>
          <button
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-base transition-colors ${
          ...
          >
            ...
            Prioridade
            <span className="ml-auto text-xs text-gray-400">{allTasks.filter((t) => !!t.priority && !t.completed && !t.deleted).length}</span>
          </button>
          <button
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-base transition-colors ${
          ...
          >
            ...
            Delegadas
            <span className="ml-auto text-xs text-gray-400">{allTasks.filter((t) => !!t.delegated && !t.completed && !t.deleted).length}</span>
          </button>
        </div>
